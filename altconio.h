...
enum colors { BLACK, BLUE, GREEN, CYAN, RED, MAGENTA, BROWN, 
              LIGHTGRAY, GRAY, LIGHTBLUE, LIGHTGREEN, TURQUOISE, LIGHTRED, PINK, YELLOW, WHITE };
...
void textcolor(unsigned short int color)
{
     setcolor(color,0);     
}
...
int align(int align,const char *str)
{
   ...
   {
    case 0:  x = (0); break;
    case 1:  x = (40-(strlen(str)/2)); break;
    case 2:  x = (80-(strlen(str))); break;
    default: return 1; break;
   }
   if(strlen(str) > 79) {}
   else { gotoxy(x,gety());printf("%s",str);}
}
